...
<head>
  ...
  <link rel = "icon" href ="admin-assets/dist/img/logoGKJ.png" type = "image/x-icon">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center" style="background-color: #CECDCD">
    <img class="animation__shake" src="{{asset('admin-assets/dist/img/logoGKJ.png')}}" alt="logoGKJ" height="300" width="300">
  </div>
